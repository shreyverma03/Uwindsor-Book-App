...
<View style={{ flex: 1 }}>
<Text style={{ textAlign: 'center', color: '#60a7db', fontSize: 18, fontFamily: 'Times New Roman' }}>Average Rating</Text>
                      <Text style={{ textAlign: 'center', color: 'white',fontWeight: 'bold', fontFamily: 'Times New Roman' }}>{book.ratings_average?book.ratings_average:'NA'}</Text>
        </View>
