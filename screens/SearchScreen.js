        ...
        <View 
            ...
            <TouchableOpacity 
                ...
                className="rounded-full p-3 m-1" >
                  <XMarkIcon size="25" color="#60a7db" />
        ...
        {/* search results */}
        {
            ...
            filteredDataSource.length>0? (
                ...
                >
                                ...
                                return (
                                    <TouchableWithoutFeedback 
                                        ...
                                        <View className="space-y-2 mb-4">
                                            ...
                                            />
                                            <Text className="ml-1" style={{ color: "#60a7db", fontSize: 20, padding:10 }}>
                                                {
                    ...
                    <View >
                              <Text style={{ marginTop: height * 0.02, color: "#60a7db", fontSize: 30, padding: 10
                              }}>Results ({filteredDataSource.length}) </Text>
